...
<small></small>
*Find the thirteen adjacent digits in the $1000$-digit number that have the greatest product. What is the value of this product?*

We can read this number into an array/list/vector of digits and perform a repeated multiplication. To further optimise this, every time the program encounters a zero, we can terminate the calculation of the product and move on.
